<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_tipoTransaccion.aspx.cs" Inherits="prj_architecture_p2.View.frm_tipoTransaccion" %>
        ...
        <div class="container mt-5">
            ...
            <div class="row">
                <div class="col-5">
                    ...
                    <asp:TextBox ID="txt_sign" runat="server" class="form-control"></asp:TextBox>
                    <br />
                    <br />
                ...
                <div class="col-7">
                    <h3 class="text-center">Lista de Tipos de Transacciones</h3>
                    <asp:GridView ID="grdTT" runat="server" AutoGenerateColumns="false" CssClass="table table-striped"
                        DataKeyNames="ID_TT, NOMBRE_TT, SIGNO_TT">
                        <Columns>
                            <asp:BoundField HeaderText="Codigo" DataField="ID_TT" />
                            <asp:BoundField HeaderText="Nombre" DataField="NOMBRE_TT" />
                            <asp:BoundField HeaderText="Signo" DataField="SIGNO_TT" />
                        </Columns>
                    </asp:GridView>
                </div>
