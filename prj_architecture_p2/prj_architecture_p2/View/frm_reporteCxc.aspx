<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_reporteCxc.aspx.cs" Inherits="prj_architecture_p2.View.frm_reporteCxc" %>
...
<head runat="server">
    ...
    <title>Reporte Cuentas x Cobrar</title>
...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="frm_cuentasXcobrar.aspx">Compleja</a></li>
    ...
    <form id="form1" runat="server">
        <div class="container mt-5">
            <h1 class="label label-default mb-4">REPORTE CXC </h1>
            <hr />
            <br />
            <div class="row">
                
                    <h2 class="text-center my-5"> PDiferencia de cada factura </h2>
                    <asp:GridView ID="grdReporte" runat="server" AutoGenerateColumns="false" CssClass="table table-striped thead-dark"
                        DataKeyNames="NUMERO_CABECERA,VALOR_CABECERA,TOTAL,RESTA">

                        <Columns>
                            <asp:BoundField HeaderText="Factura" DataField="NUMERO_CABECERA" />
                            <asp:BoundField HeaderText="Total" DataField="VALOR_CABECERA" />
                            <asp:BoundField HeaderText="Pagado" DataField="TOTAL" />
                            <asp:BoundField HeaderText="Diferencia" DataField="RESTA" />
                        </Columns>
                    </asp:GridView>
