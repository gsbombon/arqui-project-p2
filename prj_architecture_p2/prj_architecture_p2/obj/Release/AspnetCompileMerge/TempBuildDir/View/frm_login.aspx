<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_login.aspx.cs" Inherits="prj_architecture_p2.View.frm_login" %>
                                    ...
                                    <div class="card-body p-4 p-lg-5 text-black">
                                         <form id="form1" runat="server">
                                            ...
                                            <div class="pt-1 mb-4 row">
                                                <div class="col">
                                                    <asp:Button ID="btn_login" runat="server" Text="Iniciar Sesion" OnClick="btn_loginClick" class="btn btn-dark btn-lg btn-block text-white" />
                                                </div>
                                            </div>

                                            <p class="mb-3 pb-lg-2" style="color: #393f81;">No tienes cuenta? 
                                                <a href="frm_register.aspx" style="color: #393f81;">Registrarme ahora</a>
                                            </p>
                                            <div class="row">
